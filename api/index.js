...
const sendMailAovService = async (array) => {
    try {
        const response = await axios.post("https://tso-aov-sr.pttplc.com/mail/MailService", array, { httpsAgent: agent });
        if (response) {
...
module.exports = { getApiAxway, sendMailAovService, ApiClearCache };
